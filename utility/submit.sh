...
check_remote() {
  ...
  bad_remotes=(
    git@gitlab.aicrowd.com:learn-to-race/l2r-starter-kit.git
    http://gitlab.aicrowd.com/learn-to-race/l2r-starter-kit.git
    https://gitlab.aicrowd.com/learn-to-race/l2r-starter-kit.git
  )
